...
ERROR_T CDLProxy::validate_storage(bool is_combo_fmt, U64 align, U64 total, U64 bootSize, U64 userSize) const
{
    if (my_impl_->ValidateStorage(is_combo_fmt, align, total, bootSize, userSize))
    {
        return ERROR_OK;
    }
    else
