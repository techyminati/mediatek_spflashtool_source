...
XML::Node Node::AppendCommentChildNode()
{
    return Node(m_Impl->AppendCommentChildNode());
}

XML::Node Node::AppendCommentChildNode(const std::string &value)
{
    Node commentChildNode(AppendCommentChildNode());
    commentChildNode.SetText(value);
