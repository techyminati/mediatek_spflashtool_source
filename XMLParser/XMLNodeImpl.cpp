...
XML::NodeImpl *NodeImpl::AppendCommentChildNode()
{
    TiXmlComment * commentChildNode = new TiXmlComment();
    m_XMLNode->LinkEndChild(commentChildNode);
    return new NodeImpl(commentChildNode);
}
