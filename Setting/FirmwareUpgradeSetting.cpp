        ...
        Download_Scene &scene)
{
    ...
    cmd->set_combo_format(is_combo_format_);
}
...
void FirmwareUpgradeSetting::set_is_scatter_ver2(bool scatter_ver2)
{
    ISetting::set_is_scatter_ver2(scatter_ver2);
    this->readback_setting_->set_is_scatter_ver2(scatter_ver2);
    this->format_setting_->set_is_scatter_ver2(scatter_ver2);
    this->download_setting_->set_is_scatter_ver2(scatter_ver2);
    this->wm_setting_->set_is_scatter_ver2(scatter_ver2);
}
