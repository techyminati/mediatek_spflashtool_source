...
private:
    LoadScatterRunnable(const LoadScatterRunnable &rhs);
    LoadScatterRunnable & operator=(const LoadScatterRunnable &rhs);
...
private:
    LoadSCIScatterRunable(const LoadSCIScatterRunable &rhs);
    LoadSCIScatterRunable & operator=(const LoadSCIScatterRunable &rhs);
